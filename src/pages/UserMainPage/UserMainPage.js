                ...
                <div className='container mt-5'>
                    ...
                    <div className={`p-4 p-md-5 mb-4 rounded text-bg-dark ${classes.backgroundImage}`}>
                        <div className="col-md-6 px-0">
                            <em className="lead m-0">¨Jehová es mi fortaleza y mi escudo; En él confió mi corazón, y fui ayudado, Por lo que se gozó mi corazón, Y con mi cántico le alabaré.¨. (Salmo 28:7 RVR1960)</em>
                            <p className="lead m-0 mt-4"><a href="https://www.biblegateway.com/" className="text-white fw-bold">Abre la Biblia online</a></p>
                        </div>
                    </div>
                    ...
                    <div className="row mb-2">
                        <div className="col-md-6">
                            <div className={`row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative ${classes.post}`} onClick={() => history.replace(repertory)}>
                                <div className={`col p-4 d-flex flex-column position-static ${classes.post}`}>
                        ...
                        <div className="col-md-6">
                            <div className={`row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative`}>
                                <div className={`col p-4 d-flex flex-column position-static`}>
                                    <strong className="d-inline-block mb-2 text-primary">EN CONSTRUCCIÓN</strong>
                                    <h3 className="mb-0">EN CONSTRUCCIÓN</h3>
                                    <div className="mb-1 text-muted">¡Estamos en desarollo!</div>
                                    <p className="card-text mb-auto">Nuevas opciones en desarollo, ¡estén atentos!</p>
                                </div>
